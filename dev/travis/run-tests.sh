...
function simpletest_script_parse_args() {
  echo "simpletest_script_parse_args\n";
  // Set default values.
  $args = array(
    'script' => '',
    'help' => FALSE,
...
function simpletest_script_execute_batch($test_id, $test_classes) {
  global $args;
  echo "simpletest_script_execute_batch\n";
...
function simpletest_script_run_one_test($test_id, $test_class) {
  echo "simpletest_script_run_one_test\n";
  try {
    // Bootstrap Drupal.
    drupal_bootstrap(DRUPAL_BOOTSTRAP_FULL);
...
function simpletest_script_command($test_id, $test_class) {
  global $args, $php;
  echo "simpletest_script_command\n";
...
function simpletest_script_get_test_list() {
  ...
  echo "simpletest_script_get_test_list\n";
  $test_list = array();
  if ($args['all']) {
    $test_list = $all_tests;
  }
...
function simpletest_script_reporter_init() {
  ...
  echo "simpletest_script_reporter_init\n";
  $results_map = array(
    'pass' => 'Pass',
    'fail' => 'Fail',
    'exception' => 'Exception'
